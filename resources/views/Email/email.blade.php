...
<div class="container">
    ...
    <div class="illustration">
        <div class="hgroup">
            <span class="name">Hello {{ ucfirst($emaildata['name']) }},</span>

            <h3>Thank you for Signing Up with CALL LABS.</h3>
    ...
    <div class="hgroup">
        <p>
            You can choose the diagnostic lab of your choice and get your lab tests done at discounted prices with the
            quality of service kept intact.
            <br><br>
