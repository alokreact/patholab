    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('slider.update', [$slider->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputText" name="name" value="{{ $slider->position }}" />
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputText" name="url" value={{ $slider->url }}>
                  @if($errors->has('url'))
                  ...
                  @endif
                            ...
                            <div class="row mb-3">
                                ...
                                <input type="file" class="form-control" id="inputEmail" name="image" onchange="previewImage(event)">
