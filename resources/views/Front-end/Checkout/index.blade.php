                            ...
                            <div class="card-body pb-4">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
                                        <form id="appoinment-form" class="appoinment-form" method="post">
...
<script>
    ...
    $('#details_btn').on('click', function(e) {
        ...
        // if ($('input[name="pay_option"]:checked').length == 0) {
        //     $('.error_pay_option').html(
        //         '<i class=\"icofont-info-circle\"></i> &nbsp;Please select an option.');
        //     valid = false;
        // } 
    ...
    $('#pay').on('click', function(e) {
        ...
        if(valid) {
            ...
            $('.error_ad').hide();
            var checkoutUrl = "{{ route('checkout.submit')}}";
            $.ajax({
                method: 'post',
