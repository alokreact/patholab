			...
			{{-- <div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					<div class="icon d-flex align-items-center">
						...
						<a href="{{route('appointment')}}"><h4 class="mt-3 mb-3">Lab Tests at Home</h4></a>
					</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					<div class="icon d-flex align-items-center">
						...
						<a href="{{route('appointment')}}"><h4 class="mt-3 mb-3">X-Ray ECG at Home</h4></a>
					</div>
					<div class="content">
						<p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
					</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					<div class="icon d-flex align-items-center">
						...
						<a href="{{route('appointment')}}"><h4 class="mt-3 mb-3">Nurse at Home</h4></a>
					</div>
					<div class="content">
						<p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
					</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					<div class="icon d-flex align-items-center">
						...
						<a href="{{route('appointment')}}"><h4 class="mt-3 mb-3">Physiotherapist at Home</h4></a>
					</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					<div class="icon d-flex align-items-center">
						...
						<a href="{{route('appointment')}}"><h4 class="mt-3 mb-3">Medicine Home Delivery</h4></a>
					</div>
					<div class="content">
						<p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
					</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-item mb-4">
					<div class="icon d-flex align-items-center">
						...
						<a href="{{route('appointment')}}"><h4 class="mt-3 mb-3">MRI, USG , CT SCAN</h4></a>
					</div>
					<div class="content">
						<p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
					</div>
