                                        ...
                                        <div class="booking-box">
                                            <form id="#" class="address-form" method="post"
                                                ...
                                                <div class="booking-details">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="billing-address">Street
                                                                    Address</label>
                                                                <textarea class="form-control" id="address1" rows="4" placeholder="Enter full address" name="address1"></textarea>
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-main btn-round-full address-btn">Subbmit<i
