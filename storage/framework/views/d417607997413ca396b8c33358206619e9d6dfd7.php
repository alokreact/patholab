                        ...
                        <tr>
                            <td style="margin:0;padding:0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="100">
                                                ...
                                                <p>Date: <span
                                                        style="font-size:18px;font-weight:bold"><?php echo e($data['date']->format('d-m-Y')); ?>
                                        ...
                                        <tr>
                                            <td valign="top" style="font-size:24px;">
                                                <span style="text-decoration:underline;">Order
                                                    No:#<?php echo e($data['order_id']); ?></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table align="center" cellspacing="0" cellpadding="6" width="95%"
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $data['items']['name']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr width="100%">
                                                <td width="30%"
                                                    ...
                                                    <?php echo e($data['product_names'][$key]); ?>,
                                                ...
                                                <td width="20%"
                                                    ...
                                                    <span>
                                                        ...
                                                        <?php echo e($data['items']['price'][$key]); ?>/-
                                                    </span>
                                                </td>
                                            </tr>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th
                                                style="text-align:right;vertical-align:middle;border-left:1px solid #eee;border-bottom:1px solid #eee;border-right:1px solid #eee;border-top:0;font-family:Verdana, Geneva, Tahoma, sans-serif;">
                                                <span><?php echo e($data['total']); ?>/-</span>
                                            </th>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <span>Rs.<?php echo e($data['total']); ?>/-</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                ...
                                                <p style="margin:0;margin-bottom:10px;padding:0;"><strong>Name:</strong>
                                                    <?php echo e($data['address']['name']); ?></p>
                                                <p style="margin:0;margin-bottom:10px;padding:0;">
                                                    <strong>Email:</strong> <?php echo e($data['address']['email']); ?>

                                                </p>
                                                <p style="margin:0;margin-bottom:10px;padding:0;"><strong>Tel:</strong>
                                                    <?php echo e($data['phone']); ?></p>
                                                <p style="margin:0;margin-bottom:10px;padding:0;">
                                                    <strong>Address:</strong> <?php echo e($data['address']['address1']); ?>

                                                </p>
                                                <p style="margin:0;margin-bottom:10px;padding:0;">
                                                    <?php echo e($data['address']['city']); ?>, <?php echo e($data['address']['zip']); ?> </p>

                                                <p style="margin:0;margin-bottom:10px;padding:0;"><strong>Sample Pickup
                                                        date:</strong> <?php echo e($data['slot_day']); ?></p>
                                                <p style="margin:0;margin-bottom:10px;padding:0;"><strong>Sample Pickup
                                                        time:</strong> <?php echo e($data['slot_time']); ?></p>
                                            ...
                                            <td valign="top">
                                                <h4 style="font-size:24px;margin:0;padding:0;margin-bottom:10px;">
                                                    ...
                                                    <?php $__currentLoopData = $data['patients']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <p style="margin:0;margin-bottom:10px;padding:0;">
                                                            <strong>Age:</strong> <?php echo e($patient->age); ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <p style="margin:0;margin-bottom:10px;padding:0;">
                                                        <strong>Name:</strong> <?php echo e($data['patients']->name); ?>

                                                    </p>
                                                    <p style="margin:0;margin-bottom:10px;padding:0;">
                                                        <strong>Age:</strong> <?php echo e($data['patients']->age); ?>
...
<?php /**PATH C:\xampp\htdocs\patholab\resources\views/emails/order.blade.php ENDPATH**/ ?>