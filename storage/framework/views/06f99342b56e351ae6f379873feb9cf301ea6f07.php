 ...
 <!-- Bootstrap 4.3.2 -->
 <script src="<?php echo e(asset('plugins/bootstrap/js/popper.js')); ?>"></script>
 ...
 <!-- Counterup -->
 <script src="<?php echo e(asset('plugins/counterup/jquery.waypoints.min.js')); ?>"></script>

 <script src="<?php echo e(asset('plugins/shuffle/shuffle.min.js')); ?>"></script>
 ...
 <script>
     ...
     $(document).on('click', '.list-group-item', function() {
         ...
         //$('#searchSubtest-form').off('submit').submit();
                    ...
                    $.ajax({
                        url:"<?php echo e(route('searchsubtest')); ?>",
                        method:'POST',
     ...
     $(".cart_remove").click(function(e) {
         ...
         Swal.fire({
             ...
             if (result.isConfirmed) {
                 $.ajax({
                     url: "<?php echo e(route('remove_product_from_cart')); ?>",
                     method: "DELETE",
                     data: {
     ...
     $(document).on('click', '.delete_patient', function(e) {
         ...
         Swal.fire({
             ...
             if (result.isConfirmed) {
                 $.ajax({
                     method: 'post',
                     url: "<?php echo e(route('deletepatient')); ?>",
                     data: {
                         id,
                         id
                     },
     ...
     $(document).on('click', '.otp-btn', function(e) {
         ...
         if (errors.length > 0) {
             ...
             $.ajax({
                 method: 'post',
                 url: "<?php echo e(route('otp.create')); ?>",
                 data: {
                     phone,
                     phone
                 },
     ...
     $(document).on('click', '#btn-verify-otp', function() {
         ...
         $.ajax({
             url: "<?php echo e(route('otp.verify')); ?>",
             data: dataToSend,
             method: 'post',
             success: function(response, textStatus, xhr) {
                 console.log('xhr', xhr)
 ...
 <?php echo $__env->yieldContent('register_js'); ?>

 <?php echo $__env->yieldContent('search-scripts'); ?>
  <?php /**PATH C:\xampp\htdocs\patholab\resources\views/Front-end/layout/partials/footer.blade.php ENDPATH**/ ?>