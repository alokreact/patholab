<div class="flex justify-between p-2 w-full">
    <a class="flex justify-start" href="<?php echo e(route('home')); ?>">
        <img src="<?php echo e(asset('images/Logo-removebg.png')); ?>" alt="" class="w-[160px] h-[80px]">
    </a>


    <a href="<?php echo e(route('cart')); ?>" class="call-us-desk mr-1 text-black p-2">
...
<div class="hidden fixed inset-0 bg-gray-100 bg-opacity-0 z-50 mx-auto" id="mobile-menu">
            ...
            </div><?php /**PATH C:\xampp\htdocs\patholab\resources\views/Front-end/layout/partials/mobile-header.blade.php ENDPATH**/ ?>