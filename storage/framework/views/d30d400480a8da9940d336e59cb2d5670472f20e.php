...
<script src="<?php echo e(asset('admin-assets/js/jquery.js')); ?>"></script>
...
<?php echo $__env->yieldPushContent('after-lab-scripts'); ?>
<?php echo $__env->yieldPushContent('after-order-scripts'); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.js-labs').on('select2:selecting', function(e) {
            ...
            $.ajax({
                method: 'POST',
                url: "<?php echo e(route('subtestprice')); ?>",
                data: {
                    id: data.id
                },
    ...
    $('.open-modal').click(function() {
        ...
        $.ajax({
            url: "<?php echo e(route('show.order')); ?>",
            data: formData,
            type: 'GET',
            dataType: 'json',
    ...
    $(document).ready(function() {
        ...
        $('.custom-file-input').on('change', function() {
            ...
            if (fileInput) {
                ...
                //return;
                $.ajax({
                    url: '<?php echo e(route('upload.report')); ?>',
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
        ...
        $('.open-report').on('click', function() {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo e(route('get-report')); ?>",
        ...
        $('#itemModal .modal-body').on('change', '#newReport', function() {
            ...
            if (fileInput) {
                ...
                $.ajax({
                    url: '<?php echo e(route('upload.newreport')); ?>',
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
        ...
        $('.status').on('change', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('orderstatus.update')); ?>",
                method: 'post',
                data: {
                    order_status,
                    order_id
...
<?php /**PATH C:\xampp\htdocs\patholab\resources\views/Admin/layout/partials/footer.blade.php ENDPATH**/ ?>