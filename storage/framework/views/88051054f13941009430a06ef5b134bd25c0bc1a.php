...
<div class="p-3 bg-light mb-3 mt-4 referal_coupon_box">
    ...
    <div class="flex  p-1 w-[100%] mt-2  referal_coupon_applied">
        <span class="text-black p-2 referal-text">COUPON  <?php echo e($sessionArray['coupon_name']); ?>  Applied</span>
    </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\patholab\resources\views/Front-end/Checkout/template/cart/referralSection.blade.php ENDPATH**/ ?>